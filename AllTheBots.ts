...
const dateInFromZone = new Date(new Date(`1970-01-01T00:00:00.000`).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` }))
...
const [
	...
	{ value: minute },,
	{ value: second },
] = formatter.formatToParts(dateInFromZone)

console.log(formatter.formatToParts(dateInFromZone))
console.log(`${year}-${month}-${day}T${hour}:${minute}:${second}`)
console.log(new Date(`${year}-${month}-${day}T${hour}:${minute}:${second}`))


console.log(``)
console.log(new Date(new Date(`1970-01-01T00:00:00.000`)))
console.log(new Date(new Date(`1970-01-01T00:00:00.000`).toLocaleString(`en-US`, {
...
console.log(new Date(new Date(Date.parse(`1970-01-01T00:00:00.000`)).toLocaleString(`en-US`, {
    timeZone: `Europe/Oslo`,
    year: `numeric`,
    month: `2-digit`,
    day: `2-digit`,
