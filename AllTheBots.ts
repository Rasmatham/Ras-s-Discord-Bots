...
console.log(``)
console.log(new Date(`1970-01-01T00:00:00.000`))
...
console.log(new Date(`1970-01-01T00:00:00.000Z`).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` }))
console.log(``)
console.log(new Date(Date.parse(`1970-01-01T00:00:00.000`)))
console.log(new Date(Date.parse(`1970-01-01T00:00:00.000`)).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` }))
console.log(new Date(Date.parse(`1970-01-01T00:00:00.000Z`)))
console.log(new Date(Date.parse(`1970-01-01T00:00:00.000Z`)).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` }))
console.log(``)
console.log(``)
console.log(new Date(new Date(`1970-01-01T00:00:00.000`)))
console.log(new Date(new Date(`1970-01-01T00:00:00.000`).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` })))
console.log(new Date(new Date(`1970-01-01T00:00:00.000Z`)))
console.log(new Date(new Date(`1970-01-01T00:00:00.000Z`).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` })))
console.log(``)
console.log(new Date(new Date(Date.parse(`1970-01-01T00:00:00.000`))))
console.log(new Date(new Date(Date.parse(`1970-01-01T00:00:00.000`)).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` })))
console.log(new Date(new Date(Date.parse(`1970-01-01T00:00:00.000Z`))))
console.log(new Date(new Date(Date.parse(`1970-01-01T00:00:00.000Z`)).toLocaleString(`en-US`, { timeZone: `Europe/Oslo` })))
console.log(``)
/*
╔═════════════════════════════════════════════════════╦═╦═╦═╗
║ Command Prompt                                      ║-║▫║X║
