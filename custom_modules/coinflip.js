...
var flip = (message, prefix) => {
    if (message.content.toLowerCase().startsWith(`${prefix}coinflip`)) {
        ...
        var coinfilew = `./${message.client.user.username}/userinfo/${message.author.id}/coinflip/wins.log`;
        var coinfilel = `./${message.client.user.username}/userinfo/${message.author.id}/coinflip/losses.log`;
